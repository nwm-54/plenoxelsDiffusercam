...
for s in "${s_values[@]}"; do
  log_file="/home/vitran/gs7/logs2/nerf_${s}_execution_log2.txt"
  touch "$log_file"
  echo "created ${log_file}" 

  for d in "${d_values[@]}"; do
    for r in "${r_values[@]}"; do
      m_value="${s}_$((800/r))_dls${d}"
      cmd="CUDA_VISIBLE_DEVICE=1 python3 train_sim_plain.py -s /home/vitran/plenoxels/blender_data/${s} -m ./output2/${m_value} --iterations 3001 -r ${r} --dls ${d}"
