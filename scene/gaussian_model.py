...
class GaussianModel:
    ...
    def densify_and_prune(self, max_grad, min_opacity, extent, max_screen_size, radii):
        ...
        print(f"Opacity min {self.get_opacity.min().item():.4f}, max {self.get_opacity.max().item():.4f}, mean {self.get_opacity.mean().item():.4f}, median {self.get_opacity.median().item():.4f}")
