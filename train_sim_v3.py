...
if __name__ == "__main__":
    ...
    tv_train_weight = wandb.config.tv_train_weight
    args.resolution = 1
    args.dls = 14
    args.tv_weight = tv_weight
    ...
    args.resolution = 2
    args.model_path = f'./output/lego_v4_400__train_tv_{tv_train_weight:.5f})tv_{tv_weight:.5f}'
